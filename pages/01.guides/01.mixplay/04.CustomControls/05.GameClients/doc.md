...
Note that you may include more than one scope, which specifies who should receive the event. You can specify things- ke: `group:default` or `participant:e1fefc78-d4cc-4c69-b2d9-b36ed5c52893`. For more information see the [interactive protocol reference](/guides/mixplay/protocol/specification)).
